...
from dinov2.eval.finetune_cxr import get_args_parser as get_linear_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from dinov2.eval.finetune_cxr import main as linear_main
...
def main():
    description = "Submitit launcher for DINOv2 finetuning evaluation"
    ...
    submit_jobs(Evaluator, args, name="eval")
    return 0
