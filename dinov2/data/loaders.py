...
def make_data_loader(
    *,
    ...
    if not batch_balance_ds:
        ...
        sample_weights = []
        dataset_lengths = [len(ds) for ds in dataset.datasets]
        for len_ in dataset_lengths:
            sample_weights.extend([1.0/len_] * len_)
        logger.info(f"Batch balancing based on dataset source")
