...
try:
    if XFORMERS_ENABLED:
        ...
        # Ref: https://github.com/facebookresearch/dinov2/pull/195/files/942cc2dee424075a8685f87c9ac831d3762d867b
...
# <<<<<<< support_bf16
        ...
        #     assert isinstance(self.attn._fsdp_wrapped_module, MemEffAttention) or isinstance(self.attn, MemEffAttention)
        # else:
        assert isinstance(self.attn, MemEffAttention)
# =======
#         if torch.distributed.is_initialized():
#             try:
#                 assert isinstance(self.attn._fsdp_wrapped_module, MemEffAttention)
#             except:
#                 assert isinstance(self.attn, MemEffAttention)
#         else:
#             assert isinstance(self.attn, MemEffAttention)
